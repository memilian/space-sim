...
public class PNG {
    ...
    public static void saveAsPng(@NotNull FrameBuffer fb, String name) {
        FileHandle image = Gdx.files.external("directory/" + name + ".png");
        OutputStream stream = image.write(false);
        try {
            GL40.glBindFramebuffer(GL40.GL_READ_FRAMEBUFFER, fb.getFramebufferHandle());
            ...
            // unbind
            GL40.glBindFramebuffer(GL40.GL_READ_FRAMEBUFFER, 0);
